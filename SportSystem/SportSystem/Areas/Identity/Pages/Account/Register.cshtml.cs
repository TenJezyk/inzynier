...
namespace SportSystem.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.isTrainer)
                {
                    ...
                    user.ApplicationUserRoleId = new Guid("00000001-0000-0000-0000-000000000000");
                }
                else {
                    roleId = new Guid("00000002-0000-0000-0000-000000000000");
                    user.ApplicationUserRoleId = new Guid("00000002-0000-0000-0000-000000000000");
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    var addingUserResult = _userService.AddUser(new User()
                    {
                        Name = user.FirstName,
